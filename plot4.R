...
plot(datetime, power$Global_active_power, "l", ylab = "Global Active Power", xlab = "")
plot(datetime, power$Voltage, "l", ylab = "Voltage")
...
plot(datetime, power$Global_reactive_power, ylab = "Global_reacive_power", "l")
dev.off()